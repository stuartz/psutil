<?php
@ob_start(); session_start(); require_once 'includes/c04l340f.php'; require_once INC . '/f08034r.php'; $sp47dc23 = "Shipping Status Form"; require_once INC . '/h08034r.php'; ?>
...
<?php } ?>
			<tr>
				...
				<td>
						<div class="qydiv">
							<div class="qydiv1"><input type="radio" checked class="qtype" name="querytype" value="1" id="q1"> PO Search</div>
			...
			<tr>
			<td>
				<div class="ponodiv" style="display:block">
					Reference Number (PO #) :
				</div>
			...
			<tr>
				<td colspan="2" class="submitbtntd">
					<input type="button" id="getshippingstatus" value="Get Shipping Status" name="getshippingstatus">
				</td>
			</tr>
		</tbody></table>
...
<?php  $spe2c7f4 = 'shipping'; require_once INC . '/footer.php';
