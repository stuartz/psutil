<?php
define('HOAUCVLE', true); require_once 'includes/c04l340f.php'; require_once 'includes/h08034r.php'; ?>
	<body>
		<div id="license"><br>
					<h1>License for PS Utilities</h1>
			<div class="width">
				<div class="container">
					<h2><i class="icon-doc-text"></i> License Summary for Version 1.0.0</h2>
					<ul class="well">

									<li>License does not expire for Version 1.0.0.</li>
				...
				<div class="container terms">
					<h2>PS Utilities - Terms and conditions</h2><ol><li>
		<p><strong>Preamble:</strong> This Agreement, signed on Sep 23, 2017 (hereinafter: Effective Date) governs the relationship between Promotional Suppliers and Distributors, a Business Entity, (hereinafter: Licensee) and Critical Computing Rx, a private person whose principal place of business is 821 E 5th St N, Newton, IA 50208 (hereinafter: Licensor). This Agreement sets the terms, rights, restrictions and obligations on using PS Utilities (hereinafter: The Software) created and owned by Licensor, as detailed herein</p>
		</li><li>
		...
		</li></ol></li><li> <strong>Term &amp; Termination:</strong> The Term of this license shall be until terminated. Licensor may terminate this Agreement, including Licensee&rsquo;s license in the case where Licensee : <ol>
		<li>
